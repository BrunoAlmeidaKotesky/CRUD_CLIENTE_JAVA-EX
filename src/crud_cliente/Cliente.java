...
public class Cliente extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btnSalvar.addActionListener(event -> {
            ...
            //Java compare empty string and compare with null.
            if((codigo != null && nome != null && nasc != null && cpf != null) ||
               (codigo.equals("") && nome.equals("") && nasc.equals("") && cpf.equals(""))) {
                if(!editando) {
                    tabela.insertRow(new Object[] { codigo, nome, nasc, cpf});
                }
                else {
                    tabela.editRow(codigo, new Object[] { codigo, nome, nasc, cpf});
                }
            }
            editando = false;
        });
        ...
        jPanel2.add(jLabel1);
        jLabel1.setBounds(37, 2, 80, 15);

        jLabel2.setText("Nome:");
        jPanel2.add(jLabel2);
        jLabel2.setBounds(37, 39, 80, 15);

        jLabel3.setText("Nascimento:");
        jPanel2.add(jLabel3);
        jLabel3.setBounds(37, 76, 80, 15);

        jLabel4.setText("CPF:");
        jPanel2.add(jLabel4);
        jLabel4.setBounds(37, 113, 80, 15);

        txtCodigo.setToolTipText("");
        jPanel2.add(txtCodigo);
        txtCodigo.setBounds(147, 0, 100, 25);
        jPanel2.add(txtNome);
        txtNome.setBounds(147, 37, 230, 25);
        jPanel2.add(txtNasc);
        txtNasc.setBounds(147, 74, 230, 25);
        jPanel2.add(txtCpf);
        txtCpf.setBounds(147, 111, 230, 25);
